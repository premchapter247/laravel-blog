       ...
       <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 col-lg-offset-2" style="margin: auto; background: #fff">
                    ...
                    @endif
                    <form action="{{url('/store-blog')}}" id="services" method="post" enctype="multipart/form-data">
                        @csrf
                        <fieldset>
                        ...
                        <div class="form-group">
                            <label for="file" class="form-label mt-4">Image</label><br>
                            <input type="file" name="image_url" id="image-input" class="form-control" id="image-input">
