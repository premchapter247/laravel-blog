    ...
    <main id="main">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
                <img src="{{$serviceData[0]->image_url}}" class="img-fluid" alt="">
            </div>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                ...
                <div class="portfolio-info">
                    ...
                    <a href="{{url('portfollio-details')}}" title="More Details"><i class="bi bi-link"></i></a>
                    </div>
                </div>
                </div>
            </div>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="col-lg-6">
                <form action="" method="post" id= "submitContactForm" class="php-email-form">
                <div class="row gy-4">
                    @csrf
                    <div class="col-md-6">
                    <input type="text" name="name" class="form-control" placeholder="Your Name" value="{{ old('name') }}" required data-parsley-trigger="keyup" />
                    @if($errors->has('name'))
                    ...
                    <div class="col-md-12">
                    <input type="text" class="form-control" name="subject" placeholder="Subject" required data-parsley-trigger="keyup" />
                    ...
                    <div class="col-md-12">
                    <textarea class="form-control" id="message" name="message" rows="6" placeholder="Message" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 character comment.." data-parsley-validation-threshold="10" required></textarea>
                    </div>
                    
                    <div class="col-md-12 text-center">
                    <div class="loading">Loading</div>
                    <div class="error-message"></div>
                    <div class="sent-message">Your message has been submitted. Thank you!</div>
